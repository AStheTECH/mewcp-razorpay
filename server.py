...
from razorpay_mcp.cli import parse_args
from razorpay_mcp.config import configure_logging
from razorpay_mcp.tools import register_tools

configure_logging()
logger = logging.getLogger("razorpay-mcp-server")

backend = HeaderCredentialBackend()
mcp = FastMCP("MewCP Razorpay MCP Server",
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("Razorpay MCP Server Starting")
    logger.info("=" * 60)
